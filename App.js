...
import { Dimensions, Image, Linking, Pressable, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TouchableHighlight, View } from 'react-native';
      ...
      <ScrollView centerContent
        ...
        <View style={{ alignItems: "center", }}>
          ...
          <View style={{
            ...
            <Socials link={"https://www.facebook.com/profile.php?id=100086249187059"}
              image={require("./assets/images/facebook.png")}
            />
            <Socials link={"https://twitter.com/SooraTheApp"}
              image={require("./assets/images/twitter.png")}
            />
            <Socials link={"https://www.sooratheapp.com/"}
              image={require("./assets/images/instagram.png")}
            />
            <Socials link={"https://www.sooratheapp.com/"}
              image={require("./assets/images/tiktok.png")}
            />
            <Socials link={"https://www.youtube.com/channel/UCS2_jKjdg5KTLo-1zFXDO8A"}
